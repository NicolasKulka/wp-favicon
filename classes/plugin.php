...
class PWD_FAVICON_Plugin {
	...
	public static function register( $wp_customize ) {
        ...
        $wp_customize->add_control( new WP_Customize_Image_Control(
            ...
            'pwd_favicon',
            array(
                'label'    => __( 'Add a favicon for website size 16*16 or 32*32', 'pwd-favicon' ),
        ...
        $wp_customize->add_control( new WP_Customize_Image_Control(
            ...
            'pwd_admin_favicon',
            array(
                'label'    => __( 'Add a favicon for admin size 16*16 or 32*32', 'pwd-favicon' ),
                'section'  => 'custom_favicon_section',
        ...
        $wp_customize->add_control( new WP_Customize_Image_Control(
            ...
            'pwd_apple_favicon',
            array(
                'label'    => __( 'Add a Apple Touch Icon for website size 16*16 or 32*32', 'pwd-favicon' ),
                'section'  => 'custom_favicon_section',
        ...
        $wp_customize->add_control( new WP_Customize_Image_Control(
            ...
            array(
                'label'    => __( 'Add a Apple Touch Icon for admin size 16*16 or 32*32', 'pwd-favicon' ),
                'section'  => 'custom_favicon_section',
        ...
        $wp_customize->add_control( new WP_Customize_Control(
            ...
            array(
                'label'    => __( 'Disable Curved Border & reflective shine for Apple touch icon', 'pwd-favicon' ),
                'section'  => 'custom_favicon_section',
