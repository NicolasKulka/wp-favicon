<?php
/*
  Plugin Name: Plateforme WP Digital - Favicon
  Version: 1.0
...
define( 'PWD_FAVICON_FOLDER', 'faviconWP' );
...
function init_pwd_faviconplugin() {
    ...
    load_plugin_textdomain( 'pwd-favicon', false, basename( dirname( __FILE__ ) ) . '/languages/' );
